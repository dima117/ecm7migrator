...
namespace ECM7.Migrator.Providers
{
    ...
    {
		private Dictionary<DbType, SortedList<int?, string>> typeMapping =
			new Dictionary<DbType, SortedList<int?, string>>();

		public void Put1(DbType typecode, int? length, string value)
		{
		...
		public void Put1(DbType typecode, string value)
		{
			Put1(typecode, null, value);
		}
		
    
        public const string LENGTH_PLACE_HOLDER = "$l";
        public const string PRECISION_PLACE_HOLDER = "$p";
        ...
        private static string Replace(string type, int size, int precision, int scale)
        {
            ...
            return StringUtils.ReplaceOnce(type, PRECISION_PLACE_HOLDER, precision.ToString());
        }
